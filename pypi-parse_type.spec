...
Source0  : https://files.pythonhosted.org/packages/ac/f4/176019f0f1aee502602d02bbe11a63211d7b031a42c0cd305a53765156c2/parse_type-0.6.3.tar.gz
...
%prep
%setup -q -n parse_type-0.6.3
cd %{_builddir}/parse_type-0.6.3
pushd ..
cp -a parse_type-0.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724712384
